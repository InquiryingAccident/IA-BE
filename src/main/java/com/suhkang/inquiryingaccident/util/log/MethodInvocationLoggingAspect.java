...
class MethodInvocationLoggingAspect {
	...
	@Around("@annotation(me.suhsaechan.suhprojectutility.util.log.LogMethodInvocation) || @annotation(me.suhsaechan.suhprojectutility.util.log.LogMonitoringInvocation)")
